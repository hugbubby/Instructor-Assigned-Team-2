...
public class AdminController {
	...
	public void buttonAdminEmployeeClicked(Event event){
		...
		Parent kiosk = null;
		try {
			kiosk = FXMLLoader.load(getClass().getResource("Employee.fxml"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		Scene sScene = new Scene(kiosk);
	...
	public void buttonAdminAddProductClicked(Event event){
		...
		if( !(textFieldAdmin0.getText().toString().equals("") || textFieldAdmin1.getText().toString().equals("") || textFieldAdmin2.getText().toString().equals("") || textFieldAdmin3.getText().toString().equals("")) ){
			...
			Integer iNum = IKiosk.addNewProduct(textFieldAdmin0.getText().toString(), textFieldAdmin1.getText().toString(), temp.size()+1, count, price);
			if(iNum == null){
				textAreaAdmin.setText("Failed to Add : "+textFieldAdmin0.getText().toString()+"\n\nProduct Already Exists");
				return;
			}
			...
			if(textFieldAdmin0.getText().toString().equals(""))
				setText += "Error : Product Name Empty\n";
			if(textFieldAdmin1.getText().toString().equals(""))
				setText += "Error : Product Description Empty\n";
			if(textFieldAdmin2.getText().toString().equals(""))
				setText += "Error : Product Price Empty\n";
			if(textFieldAdmin3.getText().toString().equals(""))
	...
	public void buttonAdminAddAccountClicked(Event event){
		...
		textAreaAdmin.setText(setText);
		//Make sure none of the product fields are empty when adding new product
		if( !(textFieldAdmin0.getText().toString().equals("") || textFieldAdmin1.getText().toString().equals("") || textFieldAdmin2.getText().toString().equals("")) ){
			...
			Account iNum = Logs.addNewAccount(Logs.getAccounts().size()+1, type, textFieldAdmin1.getText().toString(), textFieldAdmin2.getText().toString());
			if(iNum == null){
				textAreaAdmin.setText("Failed to Add Account : "+textFieldAdmin1.getText().toString()+"\n\n Already Exists");
				return;
			}
			textAreaAdmin.setText("Succesfully Added Account # " + iNum.getAccountId());
			textFieldAdmin0.setText("");
			textFieldAdmin1.setText("");
			textFieldAdmin2.setText("");
			textFieldAdmin3.setText("");
	...
	public void buttonAdminLogoutClicked(Event event){
		...
		Parent kiosk = null;
		try {
			kiosk = FXMLLoader.load(getClass().getResource("Login.fxml"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		Scene sScene = new Scene(kiosk);
